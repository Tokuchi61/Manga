...
Bu repo su anda `Asama 17 - RoyalPass` kapsaminda kimlik, kullanici, merkezi erisim/policy, manga/chapter icerik owner, comment thread etkilesim, support intake/review, moderation queue/case, notification inbox/preference/runtime control, history continue-reading/library/timeline ve social friendship/follow/wall/messaging ile inventory definition/claim/grant/revoke/consume/equip, mission definition/progress ingest/claim/reset/runtime-control ve royalpass season/tier/progress/claim/premium-activation/runtime-control omurgasini icerir.

## Canonical Versiyon

- Canonical versiyon kaynagi: `VERSION`
- Runtime versiyon kaynagi: `APP_VERSION` environment variable
- Su anki surum: `0.17.0-alpha.1`
