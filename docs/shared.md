...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `site.maintenance.enabled` | Bakım modu anahtarı | `operations` | `admin` | `app` | `bool` | `false` | `true,false` | `site` | `-` | `all` | `-` | `false` | `immediate` | `none` | `time_window` | `true` | `site.*` | `visibility_off` | `temporarily_unavailable` | `none` | `active` | Bakım modu için referans anahtar |
...
| `feature.ads.surface.enabled` | Reklam gösterim üst yüzeylerini açma-kapama anahtarı | `access_availability` | `ads` | `access` | `bool` | `true` | `true,false` | `feature` | `ads.surface` | `all` | `-` | `false` | `immediate` | `cache_refresh` | `time_window` | `true` | `ads.surface`,`ads.placement`,`ads.delivery` | `visibility_off` | `not_found` | `none` | `active` | Global ads switch placement ve campaign alt anahtarlarını override edebilir |
| `feature.ads.placement.enabled` | Placement çözümleme yüzeyini açma-kapama anahtarı | `access_availability` | `ads` | `access` | `bool` | `true` | `true,false` | `feature` | `ads.placement` | `all` | `-` | `false` | `immediate` | `cache_refresh` | `time_window` | `true` | `ads.placement` | `visibility_off` | `not_found` | `none` | `active` | Placement resolve yüzeyi campaign serve akışından bağımsız daraltılabilir |
| `feature.ads.campaign.enabled` | Campaign serve yüzeyini açma-kapama anahtarı | `access_availability` | `ads` | `access` | `bool` | `true` | `true,false` | `feature` | `ads.campaign` | `all` | `-` | `false` | `immediate` | `cache_refresh` | `time_window` | `true` | `ads.campaign`,`ads.delivery` | `visibility_off` | `not_found` | `none` | `active` | Placement tanımları kalsa bile campaign serve ayrı kapatılabilir |
...
| `feature.payment.mana_purchase.enabled` | Mana package ve purchase entry yüzeyini açma-kapama anahtarı | `access_availability` | `payment` | `access` | `bool` | `true` | `true,false` | `feature` | `payment.mana_purchase` | `authenticated` | `-` | `false` | `immediate` | `cache_refresh` | `time_window` | `true` | `payment.mana_purchase` | `visibility_off` | `not_found` | `none` | `active` | Checkout başlatma akışı ayrı anahtar ile yönetilir |
| `feature.payment.checkout.enabled` | Checkout session başlatma yüzeyini açma-kapama anahtarı | `access_availability` | `payment` | `access` | `bool` | `true` | `true,false` | `feature` | `payment.checkout` | `authenticated` | `-` | `false` | `immediate` | `cache_refresh` | `time_window` | `true` | `payment.checkout`,`payment.provider_session` | `write_off` | `temporarily_unavailable` | `none` | `active` | Provider sorunu halinde checkout durdurulurken mana package görünürlüğü ayrı kalabilir |
| `feature.payment.transaction_read.enabled` | Kullanıcının kendi transaction veya wallet görünümünü açma-kapama anahtarı | `access_availability` | `payment` | `access` | `bool` | `true` | `true,false` | `feature` | `payment.transaction.read` | `authenticated` | `-` | `false` | `immediate` | `cache_refresh` | `time_window` | `true` | `payment.transaction.read`,`payment.wallet.read` | `visibility_off` | `not_found` | `none` | `active` | İşlem geçmişi görünümü mana purchase ve checkout akışlarından bağımsız daraltılabilir |
